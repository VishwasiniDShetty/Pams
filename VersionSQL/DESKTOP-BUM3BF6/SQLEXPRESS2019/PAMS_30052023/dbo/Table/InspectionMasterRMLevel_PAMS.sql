/****** Object:  Table [dbo].[InspectionMasterRMLevel_PAMS]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [dbo].[InspectionMasterRMLevel_PAMS](
...
CREATE UNIQUE NONCLUSTERED INDEX [NonClusteredIndex-20230310-105340] ON [dbo].[InspectionMasterRMLevel_PAMS]
(
	[Process] ASC,
	[ReportType] ASC,
	[ProcessType] ASC,
...
ALTER TABLE [dbo].[InspectionMasterRMLevel_PAMS] ADD  DEFAULT ((0)) FOR [IsMandatory]
