/****** Object:  Table [dbo].[SupplierDetails_PAMS]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [dbo].[SupplierDetails_PAMS](
	...
	[Email_SysCapacity_Size] [nvarchar](50) NULL,
	[Total_ManufacturingSpace] [nvarchar](50) NULL,
	[Company_Status] [nvarchar](50) NULL,
	[NumberOfSites] [nvarchar](50) NULL,
	[Supplier_Rep] [nvarchar](50) NULL,
...
CREATE UNIQUE CLUSTERED INDEX [ClusteredIndex-20221109-165626] ON [dbo].[SupplierDetails_PAMS]
(
	[SupplierID] ASC
...
ALTER TABLE [dbo].[SupplierDetails_PAMS] ADD  DEFAULT (newid()) FOR [FSUnique]
ALTER TABLE [dbo].[SupplierDetails_PAMS] ADD  DEFAULT ((1)) FOR [IsActive]
