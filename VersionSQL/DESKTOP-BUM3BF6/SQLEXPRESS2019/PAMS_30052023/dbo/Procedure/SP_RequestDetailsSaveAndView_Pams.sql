...
begin
	...
	begin
		...
		begin
			insert into RequestDetails_Pams(Department,vendor,process,MaterialID,PartID,RquestedID,RequestedQty,RequestedNo,RequestedBy,RequestedTS,Remarks,uom)
			VALUES(@Department,@vendor,@process,@MaterialID,@PartID,@RequestedID,@RequestedQty,@RequestedNo,@RequestedBy,@RequestedTS,@Remarks,@uom)
		END
		ELSE
		BEGIN
			UPDATE RequestDetails_Pams SET RequestedQty=@RequestedQty,RequestedBy=@RequestedBy,RequestedTS=@RequestedTS,Remarks=@Remarks,uom=@uom
	...
	begin
		...
		insert into #Temp(AutoID, Department,Vendor,Process,MaterialID,PartID,RquestedID,RequestedQty,RequestedNo,RequestedBy,RequestedTS,ApprovedBy,ApprovedTS,Status,Remarks,UOM,HoldRemarks,ClosedRemarks)
		select r1.AutoID,r1.Department,r1.vendor,r1.process,r1.MaterialID,r1.PartID,r1.RquestedID,r1.RequestedQty,r1.RequestedNo,r1.RequestedBy,r1.RequestedTS,r1.ApprovedBy,r1.ApprovedTS,isnull(r1.Status,'') as Status,r1.Remarks,r1.uom,r1.HoldRemarks,r1.ClosedRemarks from RequestDetails_Pams r1 
		...
		begin
			...
			when (UOM='Kg' and isnull(RequestedQty,0)>isnull(IssuedQty_KG,0)) then (isnull(RequestedQty,0)-isnull(IssuedQty_KG,0)) else 0 end as PendingQty,r1.RequestedNo,r1.RequestedBy,r1.RequestedTS,r1.ApprovedBy,r1.ApprovedTS,isnull(r1.Status,'') as Status,r1.Remarks,r1.uom,r1.HoldRemarks,r1.ClosedRemarks
