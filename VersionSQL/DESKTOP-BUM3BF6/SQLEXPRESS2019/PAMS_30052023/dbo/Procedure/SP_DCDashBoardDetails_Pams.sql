...
BEGIN
	...
	VendorDCDate,ReceivedQty_kg,ReceivedQty_No,Remarks,Received_UOM,DCStatus,DCCloseStatus,DCCloseRemarks,DCGateExitBit )'
	...
	d2.VendorDCNo,d2.VendorDCDate,d2.ReceivedQty_kg,d2.ReceivedQty_No,d2.Remarks,d2.Received_UOM,d1.DCStatus,d1.DCCloseStatus,d1.DCCloseRemarks,d3.DCGateExitBit  from DCNoGeneration_PAMS D1 
	left join (select distinct PamsDCNo,MaterialID,PartID,Vendor,process,GRNNo,MJCNo,PJCNo,VendorDCNo,VendorDCDate,Qty_KG as ReceivedQty_kg,Qty_Numbers as ReceivedQty_No,Remarks,UOM as Received_UOM  from DCStoresDetails_PAMS) d2
