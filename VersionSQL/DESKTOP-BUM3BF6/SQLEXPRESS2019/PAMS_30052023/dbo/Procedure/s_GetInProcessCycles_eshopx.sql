...
Insert into #Inprocesscycles(sttime,ndtime,mc,comp,opn,opr,[id],datatype,WorkOrderNumber)
...
Insert into #Inprocesscycles(sttime,ndtime,mc,comp,opn,opr,[id],datatype,WorkOrderNumber)
select sttime,ndtime,mc,comp,opn,opr,id,'42','0' from autodata_ICD
...
(componentoperationpricing.cycletime - componentoperationpricing.machiningtime) as stdlLoadUnloadTime,a.WorkOrderNumber
...
select ComponentID,description,OperationNo,operationdescription,OperatorID,OperatorName,sttime,ndtime,CycleTime,0 as partscount,WorkOrderNumber,mc,comp,opn,PDT,LoadUnloadTime,Remarks,StdCycleTime,StdMachiningTime,id,In_Cycle_DownTime,stdmctime,stdlLoadUnloadTime,0,0 as spindlecycletime from #Temp --ER0350
where datatype=11
